...
export function getChimieSuiviSections(): LessonSection[] {
  return [
    ...
    { id: "ask-ai", type: "ask-ai", title: "Demander au Prof IA", icon: "🤖", content: <AITutorPanel subject="Chimie — Suivi temporel" /> },
    { id: "draw-me", type: "draw-me", title: "Dessine-moi", icon: "✏️", content: <DrawMePanel subject="chemistry" options={[{ label: "Décroissance exponentielle", icon: "📉", description: "[A] vs t pour ordre 1", variant: "kinetics" }, { label: "Suivi temporel interactif", icon: "⏱️", description: "Modifie k et observe l'effet", variant: "temporel" }]} /> },
